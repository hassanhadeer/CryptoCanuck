#pragma checksum "C:\Users\Hassan Abu Hadeer\OneDrive - triOS College\WinMobileDev\file\CryptoCanuck\final copy\CryptoCanuck-master\CryptoCanuck-master\Pages\History.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3788f5f099275f4de0733dfaad01f55d31025b72"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3788f5f099275f4de0733dfaad01f55d31025b72", @"/Pages/History.cshtml")]
    ...
    public class Pages_History : global::Microsoft.AspNetCore.Mvc.RazorPages.Page
    {
        ...
        {
#nullable restore
#line 3 "C:\Users\Hassan Abu Hadeer\OneDrive - triOS College\WinMobileDev\file\CryptoCanuck\final copy\CryptoCanuck-master\CryptoCanuck-master\Pages\History.cshtml"
...
<div class=""historyContainer"">
    ...
    <div id=""historySection1"" class=""historyDetails"">
        ...
        <iframe src=""https://www.youtube.com/embed/eIP7IflP1gs?rel=0&fs=0&color=white"" width=""400"" height=""315"" frameborder=""0""></if");
            WriteLiteral(@"rame>
        </div>
    </div>
    ...
    <div id=""historySection2"">
        ...
        The early month of 2011 was the momentous year for Bitcoin as it was traded through the SilkRoad. Whereas WikiLeaks started to accept the donation as a form of bitcoin. The momentum was getting higher when it was traded through the dark web known as SilkRoad. However, ");
            WriteLiteral(@"in 2013 the FBI has seized the account of Mt. Gox who was behind the bitcoin exchange.<br> 
    ...
    <div id=""historySection4"" class=""historyText"">
        <div>
            ...
            In this year, a researcher called Gvern branwen bought a de");
            WriteLiteral(@"leted messages and emails of an Australian man called Dr. Craig S.Wright declaring he was Satoshi Nakamoto, the creator of Bitcoin. Wright announced: He was Satoshi Nakamoto through a blog post.<br> 
           ...
           <br><br>
          <p>
            In 2017 it gains more legitimacy among lawmakers and financial companies, and number of GitHub projects related with bitcoin exceeds 10,000. Bitcoin symbol was encoded Unicode version 10.0 at position U+ 20BF (B) in the currency symbol");
            WriteLiteral(@" block. Bitcoin split into two derivative digital currencies, the classic bitcoin (BTC) and the Bitcoin Cash (BCH). The split has been called the BITCOIN CASH HARD FORK.
        ...
        <div>
            The Bitcoin's price in 2018 has been dropping all year. It dropped 50% in 16 days, falling below $7,000. Wall Street Journal declared that P");
            WriteLiteral(@"eter Thiel Foundation bought millions of dollars in bitcoin, but it's unclear if they sold any of their stocks. The financial authorities of Korea began an investigation of services related to cryptocurrencies provided by local banks after coinmarketcap removed prices from South Korean exchanges from it's cryptocurrency settlements without warning, that led to a sharp drop in all prices.
            ...
            Bitcoin price ");
            WriteLiteral(@"falls below $6000 on November 14th, and on 24th falls below $4000.
    ...
    <div id=""historySection5"">
           <im");
            WriteLiteral(@"g class=""historyChartB"" src=""assets/historyPhotos/chartB.png""
           alt=""photo"">        
    </div>
    ...
    <div id=""historySection6"" class=""historySec"">
         ...
         <p>
            ...
            Bitcoin price path was changed in 2020 because of its ");
            WriteLiteral(@"growing adoption as a hedge against the potential currency debasement that might come from trillions of dollars of coronavirus-related stimulus payments from central banks and governments around the world
